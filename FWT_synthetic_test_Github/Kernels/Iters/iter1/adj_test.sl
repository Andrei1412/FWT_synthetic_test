...
#srun python ../../Read_GP_adj_calc_i_new_ts_PS_arrival.py
srun python ../../Read_GP_adj_calc_i_new_displacement_ts.py
#srun python ../../Read_GP_adj_calc_i_new_v8_ts_new.py
#srun python ../../Read_GP_adj_calc_i_new_v8_ts_corrected.py
echo "Done" `date`
exit
